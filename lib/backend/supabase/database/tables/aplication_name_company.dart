...
class AplicationNameCompanyTable
    extends SupabaseTable<AplicationNameCompanyRow> {
  @override
  String get tableName => 'aplication_name_company';

  @override
  AplicationNameCompanyRow createRow(Map<String, dynamic> data) =>
      AplicationNameCompanyRow(data);
}

class AplicationNameCompanyRow extends SupabaseDataRow {
  AplicationNameCompanyRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AplicationNameCompanyTable();
