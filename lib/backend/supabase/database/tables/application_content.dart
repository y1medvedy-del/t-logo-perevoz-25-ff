...
class ApplicationContentTable extends SupabaseTable<ApplicationContentRow> {
  @override
  String get tableName => 'application_content';

  @override
  ApplicationContentRow createRow(Map<String, dynamic> data) =>
      ApplicationContentRow(data);
}

class ApplicationContentRow extends SupabaseDataRow {
  ApplicationContentRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ApplicationContentTable();
