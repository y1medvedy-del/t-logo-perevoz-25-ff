...
class ActWorkTable extends SupabaseTable<ActWorkRow> {
  @override
  String get tableName => 'act_work';

  @override
  ActWorkRow createRow(Map<String, dynamic> data) => ActWorkRow(data);
}

class ActWorkRow extends SupabaseDataRow {
  ActWorkRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ActWorkTable();
