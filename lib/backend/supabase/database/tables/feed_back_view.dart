...
class FeedBackViewTable extends SupabaseTable<FeedBackViewRow> {
  @override
  String get tableName => 'feed_back_view';

  @override
  FeedBackViewRow createRow(Map<String, dynamic> data) => FeedBackViewRow(data);
}

class FeedBackViewRow extends SupabaseDataRow {
  FeedBackViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => FeedBackViewTable();
