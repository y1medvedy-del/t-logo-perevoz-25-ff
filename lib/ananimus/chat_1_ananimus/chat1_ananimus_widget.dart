...
import '/chat/list_plug/list_plug_widget.dart';
...
import 'chat1_ananimus_model.dart';
export 'chat1_ananimus_model.dart';

class Chat1AnanimusWidget extends StatefulWidget {
  const Chat1AnanimusWidget({
    super.key,
    this.idChatBack,
  });
  ...
  static String routeName = 'chat_1_Ananimus';
  static String routePath = 'chat1Ananimus';

  @override
  State<Chat1AnanimusWidget> createState() => _Chat1AnanimusWidgetState();
}

class _Chat1AnanimusWidgetState extends State<Chat1AnanimusWidget> {
  late Chat1AnanimusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chat1AnanimusModel());
    ...
    return FutureBuilder<List<ChatWithUserAndApplicationInfoRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChatWithUserAndApplicationInfoRow>
            chat1AnanimusChatWithUserAndApplicationInfoRowList = snapshot.data!;
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Align(
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final containerVar =
                                                            chat1AnanimusChatWithUserAndApplicationInfoRowList
                                                                .where((e) =>
                                                                    e.chatAdmin ==
                                                                    false)
                                                                .toList();
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  NotificationsWidget(
                                                                                    key: Key('Key1lu_${containerVarIndex}_of_${containerVar.length}'),
