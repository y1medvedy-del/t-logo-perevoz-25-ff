...
class Chat2Widget extends StatefulWidget {
  const Chat2Widget({
    ...
    required this.idResipient,
    this.textMessage,
    String? namePage,
  }) : this.namePage = namePage ?? 'Страница';

  final int? idChat;
  final int? idResipient;
                                                                          ...
                                                                          await Navigator
                                                                            ...
                                                                            PageTransition(
                                                                              ...
                                                                              child: FlutterFlowExpandedImageView(
                                                                                ...
                                                                                allowRotation: false,
                                                                                tag: containerVarItem.photoMessage!,
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        path: valueOrDefault<
                                                                          ...
                                                                          containerVarItem
                                                                              .videoMessage,
                                                                          'https://supabase.t-logo.ru/storage/v1/object/public/photo_application_compr/1/1730983730753000.mp4',
                                                                        ),
                                                                        videoType:
                                                                            VideoType.network,
                                                                        autoPlay:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                height: 105.0,
                                                                                width: 240.0,
                                                                                child: ChatImageCameraAndGelleryWidget(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                height: 105.0,
                                                                                width: 240.0,
                                                                                child: ChatVideoCameraAndGelleryWidget(
                                                                                  idChat: widget.idChat!,
                                                                                  textMessage: _model.textController.text,
                                                                                ),
                                                                              ),
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  if (selectedFiles !=
                                                                      null) {
                                                                    safeSetState(() =>
                                                                        _model.isDataUploading_uploadDataJt9d =
                                                                            true);
                                                                    ...
                                                                    if (selectedUploadedFiles.length ==
                                                                      ...
                                                                      safeSetState(
                                                                          () {
                                                                        _model.uploadedLocalFile_uploadDataJt9d =
                                                                            selectedUploadedFiles.first;
                                                                        _model.uploadedFileUrl_uploadDataJt9d =
                                                                            downloadUrls.first;
                                                                      });
                                                                    } else {
                                                                      safeSetState(
                                                                  ...
                                                                  if (_model.uploadedFileUrl_uploadDataJt9d !=
                                                                          '') {
                                                                    unawaited(
                                                                      () async {
                                                                        _model.messageDoc =
                                        ...
                                        children: [
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Image.network(
                                                valueOrDefault<String>(
                                                  rowUserRow?.avatar,
                                                  'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/t-logo-b-i-g-e-t-s-k-l-a-d-khmvw1/assets/l9ovrryy9l8e/Icn_(16).png',
                                                ),
                                                width: 32.0,
                                                height: 32.0,
                                                fit: BoxFit.cover,
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Text(
                                                valueOrDefault<String>(
                                                  '${rowUserRow?.surname} ${rowUserRow?.name}',
                                                  'Фамилия Имя',
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
