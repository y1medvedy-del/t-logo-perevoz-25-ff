...
import 'text_fild_model.dart';
export 'text_fild_model.dart';
...
class _TextFildWidgetState extends State<TextFildWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextFildModel());

    _model.textController ??= TextEditingController(text: widget.text2);
