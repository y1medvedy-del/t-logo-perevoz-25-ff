...
import 'dart:async';
import '/index.dart';
import 'apllication6_widget.dart' show Apllication6Widget;
import 'package:flutter/material.dart';

class Apllication6Model extends FlutterFlowModel<Apllication6Widget> {
  ...
  // Stores action output result for [Custom Action - checkPayment] action in apllication_6 widget.
