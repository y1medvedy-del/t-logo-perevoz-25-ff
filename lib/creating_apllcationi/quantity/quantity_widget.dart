    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      safeSetState(() {
        _model.textController?.text =
            (widget.quantity > 0 ? widget.quantity.toString() : ' ');
    ...
    return Shortcuts(
      shortcuts: {
        SingleActivator(
          ...
          FFAppState().updateAplicationLocalStruct(
            (e) => e
              ..declaredWorks = functions
                  .worksListEdit(
                      FFAppState().aplicationLocal.declaredWorks.toList(),
                      widget.text,
                      _model.textController.text,
      ...
      child: Actions(
        ...
        child: Focus(
          ...
          focusNode: _model.quantityShortcutsFocusNode,
          child: GestureDetector(
              onTap: () => _model.quantityShortcutsFocusNode.canRequestFocus
                  ? FocusScope.of(context)
                      .requestFocus(_model.quantityShortcutsFocusNode)
