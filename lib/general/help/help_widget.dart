                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        24.0, 30.0, 24.0, 0.0),
                                    child: Text(
                                      'Напишите тему, например: деньги за заказ',
                                ...
                                Flexible(
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 30.0, 0.0, 0.0),
                                    child:
                                        FutureBuilder<List<TopicsSupportRow>>(
                                      future: TopicsSupportTable().queryRows(
                                        queryFn: (q) => q
                                            .eqOrNull(
                                              'carrier',
                                              true,
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<TopicsSupportRow>
                                            containerTopicsSupportRowList =
                                            snapshot.data!;
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    24.0, 0.0, 24.0, 0.0),
                                            child: FutureBuilder<
                                                List<QuestionsSupportRow>>(
                                              future: QuestionsSupportTable()
                                                  .queryRows(
                                                queryFn: (q) => q
                                                    .eqOrNull(
                                                      'carrier',
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<QuestionsSupportRow>
                                                    containerQuestionsSupportRowList =
                                                    snapshot.data!;
                                                                  ...
                                                                  children: [
                                                                      ...
                                                                      children: [
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                                (context) {
                                                                              if (containerVarItem.icon == null || containerVarItem.icon == '') {
                                                                                return Padding(
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        builder:
                                                                            (context) {
                                                                          final questions = containerQuestionsSupportRowList
                                                                              .where((e) => e.topic == containerVarItem.id)
                                                                              .toList();
                                                                            ...
                                                                            itemBuilder:
                                                                              ...
                                                                              return Padding(
                                                                                ...
                                                                                child: InkWell(
                                                                                  ...
                                                                                  onTap: () async {
                                                                                    context.pushNamed(
                                                                                      Help1Widget.routeName,
                                                                                      queryParameters: {
                                                                                        'nameQuestion': serializeParam(
                                                                                          questionsItem.name,
                                                                                          ParamType.String,
                                                                                        ),
                                                                                        'idQuestion': serializeParam(
                                                                                          questionsItem.id,
                                                                                          ParamType.int,
                                                                                        ),
                                                                                      }.withoutNulls,
