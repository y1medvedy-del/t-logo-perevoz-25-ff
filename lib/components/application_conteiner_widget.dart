...
import 'application_conteiner_model.dart';
export 'application_conteiner_model.dart';

/// Контейнер на главной странице
class ApplicationConteinerWidget extends StatefulWidget {
  const ApplicationConteinerWidget({
    super.key,
  ...
  @override
  State<ApplicationConteinerWidget> createState() =>
      _ApplicationConteinerWidgetState();
}

class _ApplicationConteinerWidgetState extends State<ApplicationConteinerWidget>
    with TickerProviderStateMixin {
  late ApplicationConteinerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ApplicationConteinerModel());
